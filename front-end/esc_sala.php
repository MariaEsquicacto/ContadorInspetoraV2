...
if (empty($categoriaSelecionada) || empty($dataSelecionada) || $dadosCategoria === null) {
    header("Location: contagem2.php"); // Volta para a página de seleção de categoria
    exit;
}
...
<head>
    ...
    <link rel="stylesheet" href="../front-end/css/esc_sala.css?v=1.5">
...
<body>
    ...
    <main>
        ...
        <!-- <section class="conteiner">
            ...
            <div class="botoes">
                <a href="contagem.html"><button type="submit">1° Ano</button></a>
                <button type="submit">2° Ano</button>
            </div>
        </section>
        <section class="buttonfeito">
            <a href="contagem2.html"><button type="submit">Feito</button></a>
        </section> -->
                ...
                btnFeitoTelaSalas.addEventListener('click', async () => {
                    ...
                    try {
                        ...
                        if (response.ok) { // Se a resposta HTTP for 2xx (Sucesso)
                            ...
                            window.location.href = `contagem2.php?data=${encodeURIComponent(dataSelecionadaPHP)}`;
                        } else {
